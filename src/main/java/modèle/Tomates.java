...
public class Tomates {
     ...
     * @return Une liste de tomates du type spécifié.
     */
    private static List<Tomate> tomatesDeTypeAvecListe(TypeTomate typeTomate, List<Tomate> tomates) {
    	List<Tomate> resultat = new ArrayList<Tomate>();
     ...
     * @return Une liste de tomates de la couleur spécifiée.
     */
    private static List<Tomate> tomatesDeCouleurAvecListe(Couleur couleur, List<Tomate> tomates) {
        List<Tomate> resultat = new ArrayList<Tomate>();
        for (Tomate t : tomates) {
